#!/usr/bin/env python3
"""Train Model E: Model B plus seven entity-level temporal features (card1-6 + addr1)."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/models/model_e"))
    parser.add_argument("--report", type=Path, default=Path("docs/MODEL_E_BASELINE.md"))
...
if __name__ == "__main__":
    try:
        ...
        print(f"train_model_e.py: {error}", file=sys.stderr)
        sys.exit(1)